...
main(int argc, char *argv[])
{
  ...
  12:	76250513          	addi	a0,a0,1890 # 770 <malloc+0xec>
  16:	00000097          	auipc	ra,0x0
  1a:	5b0080e7          	jalr	1456(ra) # 5c6 <printf>
        exit();
  1e:	00000097          	auipc	ra,0x0
  22:	210080e7          	jalr	528(ra) # 22e <exit>
    }

    int i = atoi(argv[1]);
  26:	6588                	ld	a0,8(a1)
  28:	00000097          	auipc	ra,0x0
  2c:	18a080e7          	jalr	394(ra) # 1b2 <atoi>

    sleep(i);
  30:	00000097          	auipc	ra,0x0
  34:	28e080e7          	jalr	654(ra) # 2be <sleep>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 336:	45e50513          	addi	a0,a0,1118 # 790 <digits>
 33a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 402:	392b8b93          	addi	s7,s7,914 # 790 <digits>
 ...
 542:	24a90913          	addi	s2,s2,586 # 788 <malloc+0x104>
        while(*s != 0){
...
free(void *ap)
{
 ...
 60a:	1a27b783          	ld	a5,418(a5) # 7a8 <freep>
 ...
 638:	00e6ea63          	bltu	a3,a4,64c <free+0x50>
{
 ...
 67a:	12f73923          	sd	a5,306(a4) # 7a8 <freep>
}
 67e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6ac:	10053503          	ld	a0,256(a0) # 7a8 <freep>
 ...
 6d4:	0d890913          	addi	s2,s2,216 # 7a8 <freep>
  if(p == (char*)-1)
 6d8:	5afd                	li	s5,-1
 6da:	a895                	j	74e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 6dc:	00000797          	auipc	a5,0x0
 6e0:	0d478793          	addi	a5,a5,212 # 7b0 <base>
 6e4:	00000717          	auipc	a4,0x0
 6e8:	0cf73223          	sd	a5,196(a4) # 7a8 <freep>
 6ec:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 710:	08a73e23          	sd	a0,156(a4) # 7a8 <freep>
      return (void*)(p + 1);
